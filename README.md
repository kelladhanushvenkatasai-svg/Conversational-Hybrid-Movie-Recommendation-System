...
Below is an example of the movie recommendation results generated by the system when querying:

> "Action and Adventure movies with Tom Cruise"

![Recommendation Output](assets/output_demo.png)
# Future Improvements
